...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x4800076Cu)

/* UDB_0_4_1_CONFIG Address: CYDEV_UCFG_B0_P6_U0_BASE Size (bytes): 128 */
#define BS_UDB_0_4_1_CONFIG_VAL ((const uint8 CYFAR *)0x48000774u)
...
#define BS_IOPINS1_7_VAL ((const uint8 CYFAR *)0x48000800u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT12_AG, 0x30u);
