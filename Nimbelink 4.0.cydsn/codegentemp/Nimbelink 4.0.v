// ======================================================================
// Nimbelink 4.0.v generated from TopDesign.cysch
// 07/26/2016 at 14:26
...
module UART_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("6ff184cb-bcd5-41a3-9d57-d67650e03cbf/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
// UART_v2_50(Address1=0, Address2=0, BaudRate=115200, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, Enable_RX=1, Enable_RXIntInterrupt=1, Enable_TX=1, Enable_TXIntInterrupt=1, EnableHWAddress=0, EnIntRXInterrupt=true, EnIntTXInterrupt=true, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=true, InternalClock=true, InternalClockToleranceMinus=3.93736842105263, InternalClockTolerancePlus=3.93736842105263, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=1, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=true, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=true, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=921600, RXAddressMode=0, RXBufferSize=15, RxBuffRegSizeReplacementString=uint8, RXEnable=true, TXBitClkGenDP=true, TXBufferSize=15, TxBuffRegSizeReplacementString=uint8, TXEnable=true, Use23Polling=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=UART_v2_50, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UART_SRV, CY_INSTANCE_SHORT_NAME=UART_SRV, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=UART_SRV, )
module UART_v2_50_3 (
    rx_clk,
    rx_data,
    tx_clk,
	...
	cy_clock_v1_0
		#(.id("7464b772-a642-4f2a-bd40-0fe3bbabdf79/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1085069444.44444"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("04c4d29d-df00-4874-8352-b3b9c5f4e2c1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    UART_v2_50_0 UART_NL (
        ...
        .rx_data(Net_172),
        .rx_clk(Net_173));
    defparam UART_NL.Address1 = 0;
    defparam UART_NL.Address2 = 0;
    defparam UART_NL.EnIntRXInterrupt = 1;
    defparam UART_NL.EnIntTXInterrupt = 1;
    defparam UART_NL.FlowControl = 0;
    defparam UART_NL.HalfDuplexEn = 0;
    defparam UART_NL.HwTXEnSignal = 1;
    defparam UART_NL.NumDataBits = 8;
    defparam UART_NL.NumStopBits = 1;
    defparam UART_NL.ParityType = 0;
    defparam UART_NL.RXEnable = 1;
    defparam UART_NL.TXEnable = 1;
	...
	wire [0:0] tmpOE__ON_OFF_net;
	wire [0:0] tmpFB_0__ON_OFF_net;
	wire [0:0] tmpIO_0__ON_OFF_net;
	wire [0:0] tmpINTERRUPT_0__ON_OFF_net;
	electrical [0:0] tmpSIOVREF__ON_OFF_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		ON_OFF
		 (.oe(tmpOE__ON_OFF_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ON_OFF_net[0:0]}),
		  .io({tmpIO_0__ON_OFF_net[0:0]}),
		  .siovref(tmpSIOVREF__ON_OFF_net),
		  .interrupt({tmpINTERRUPT_0__ON_OFF_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ON_OFF_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_3 UART_SRV (
        ...
        .reset(1'b0),
        .rx(Net_180),
        .tx_interrupt(Net_181),
        .rx_interrupt(Net_182),
        .tx_data(Net_183),
        .tx_clk(Net_184),
        .rx_data(Net_185),
        .rx_clk(Net_186));
    defparam UART_SRV.Address1 = 0;
    defparam UART_SRV.Address2 = 0;
    defparam UART_SRV.EnIntRXInterrupt = 1;
    defparam UART_SRV.EnIntTXInterrupt = 1;
    defparam UART_SRV.FlowControl = 0;
    defparam UART_SRV.HalfDuplexEn = 0;
    defparam UART_SRV.HwTXEnSignal = 1;
    defparam UART_SRV.NumDataBits = 8;
    defparam UART_SRV.NumStopBits = 1;
    defparam UART_SRV.ParityType = 0;
    defparam UART_SRV.RXEnable = 1;
    defparam UART_SRV.TXEnable = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("e4ea2637-b1e9-47b6-ab1d-d3a1f681b315"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1d05bfe0-a52c-4e2f-a568-0632512aae4d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
